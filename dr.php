...
if ($result->num_rows > 0) {
 echo "<table><tr><th>Route ID </th><th>From</th><th>To</th><th>Distance</th></tr>";
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["routeid"]. "</td><td> " . $row["from1"]. "</td><td>". $row["to1"]. "</td><td>". $row["distance"]. "</td><td><form name='delete' action='dr1.php' method='POST'><button type='submit' name='delete' value='". $row["routeid"]. "' >Delete</button></form></td></tr><br>";
    }
} else {
